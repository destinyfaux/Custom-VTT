        ...
        <div className="bg-bgPanel rounded border border-borderDark mb-2 overflow-hidden">
            ...
            {/* SFX Section */}
                    ...
                    {audioList.sfx.map(s => <option key={s} value={s}>{s}</option>)}
                        ...
                        <button
                            className="w-full mt-2 bg-accentGold/20 border border-accentGold/50 text-accentGold font-bold py-1 rounded text-[10px] hover:bg-accentGold/30 transition-colors"
            ...
            {showDesigner && <SoundDesigner onClose={() => setShowDesigner(false)} />}
        </div>
    );
}